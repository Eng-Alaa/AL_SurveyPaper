...
def Plot_contour(X,rf_model_tot,rf_model_AL,rf_model_Ep,X_pool_tot,y_pool_tot,X_labeled_tot,y_labeled_tot,x_selected_tot,X_pool_AL,y_pool_AL,X_labeled_AL,y_labeled_AL,x_selected_AL,X_pool_Ep,y_pool_Ep,X_labeled_Ep,y_labeled_Ep,x_selected_Ep):
    ...
    im0 = axs[0].scatter(X_pool_tot[y_pool_tot==0, 0], X_pool_tot[y_pool_tot==0, 1], c='red', marker='+', label='Unlabeled Point (class 0)')
    im0 = axs[0].scatter(X_pool_tot[y_pool_tot==1, 0], X_pool_tot[y_pool_tot==1, 1], c='green', marker='+', label='Unlabeled Point (class 1)')
    im0 = axs[0].scatter(X_labeled_tot[y_labeled_tot==0, 0], X_labeled_tot[y_labeled_tot==0, 1], c='red', marker='o', label='Labeled Point (class 0)')
    im0 = axs[0].scatter(X_labeled_tot[y_labeled_tot==1, 0], X_labeled_tot[y_labeled_tot==1, 1], c='green', marker='o', label='Labeled Point (class 1)')
    im0 = axs[0].scatter(x_selected_tot[0, 0], x_selected_tot[:, 1], c='black', marker='s', label='Selected point')
    ...
    im1 = axs[1].scatter(X_pool_AL[y_pool_AL==0, 0], X_pool_AL[y_pool_AL==0, 1], c='red', marker='+', label='Unlabeled Point (class 0)')
    im1 = axs[1].scatter(X_pool_AL[y_pool_AL==1, 0], X_pool_AL[y_pool_AL==1, 1], c='green', marker='+', label='Unlabeled Point (class 1)')
    im1 = axs[1].scatter(X_labeled_AL[y_labeled_AL==0, 0], X_labeled_AL[y_labeled_AL==0, 1], c='red', marker='o', label='Labeled Point (class 0)')
    im1 = axs[1].scatter(X_labeled_AL[y_labeled_AL==1, 0], X_labeled_AL[y_labeled_AL==1, 1], c='green', marker='o', label='Labeled Point (class 1)')
    ...
    im2 = axs[2].scatter(X_pool_Ep[y_pool_Ep==0, 0], X_pool_Ep[y_pool_Ep==0, 1], c='red', marker='+', label='Unlabeled Point (class 0)')
    im2 = axs[2].scatter(X_pool_Ep[y_pool_Ep==1, 0], X_pool_Ep[y_pool_Ep==1, 1], c='green', marker='+', label='Unlabeled Point (class 1)')
    im2 = axs[2].scatter(X_labeled_Ep[y_labeled_Ep==0, 0], X_labeled_Ep[y_labeled_Ep==0, 1], c='red', marker='o', label='Labeled Point (class 0)')
    im2 = axs[2].scatter(X_labeled_Ep[y_labeled_Ep==1, 0], X_labeled_Ep[y_labeled_Ep==1, 1], c='green', marker='o', label='Labeled Point (class 1)')
